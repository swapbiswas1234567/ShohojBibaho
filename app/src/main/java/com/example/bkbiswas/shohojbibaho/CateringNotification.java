...
public class CateringNotification {
    String sender, receiver, itemName, senderContactNo, senderEmail, receiverEmail;

    public CateringNotification(String sender, String receiver, String itemName, String senderContactNo, String senderEmail, String receiverEmail) {
        this.sender = sender;
